        ...
        return (
          <View style={consultantFlowStyles.section}>
            ...
            <View style={consultantProfileFlowStyles.reviewSectionContent}>
              ...
              <Text style={consultantProfileFlowStyles.summaryText}>Category: {category}</Text>
    ...
    <SafeAreaView style={consultantFlowStyles.container}>
      ...
      <ScrollView style={consultantProfileFlowStyles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <View style={consultantProfileFlowStyles.buttonContainer}>
          {currentStep > 0 && (
            <TouchableOpacity
              style={[consultantFlowStyles.submitButton, consultantProfileFlowStyles.previousButton, consultantProfileFlowStyles.buttonFlex]}
          ...
          {currentStep < FORM_STEPS.length - 1 ? (
            <TouchableOpacity
              style={[consultantFlowStyles.submitButton, currentStep === 0 ? consultantProfileFlowStyles.buttonFlexFull : consultantProfileFlowStyles.buttonFlex]}
