        ...
        try {
          ...
          if (studentResponse.data) {
            studentDetailsMap.set(studentId, {
              ...
              profileImage: studentResponse.data.profileImage || studentResponse.data.avatar || null
            });
          }
        } catch {
          console.log(`⚠️ [ConsultantHome] Could not fetch student details for ${studentId}`);
          studentDetailsMap.set(studentId, {
            ...
            {bookingRequests.map((request) => {
              ...
              return (
                <LeadCard
                  ...
                  avatarUri={request.studentProfileImage ? { uri: request.studentProfileImage } : require('../../../assets/image/avatar.png')}
