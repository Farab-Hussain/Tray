...
import { recruiterApplicationReviewScreenStyles } from '../../../constants/styles/applicationReviewScreenStyles';
...
const ApplicationReviewScreen = ({ navigation, route }: any) => {
  ...
  const handleUpdateStatus = async (status: string) => {
    Alert.alert('Update Status', `Change application status to "${status}"?`, [
...
const styles = recruiterApplicationReviewScreenStyles;
